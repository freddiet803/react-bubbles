...
- [ ] Explain what a token is used for.
  ...
  A token is used to make security decisions and to store tamper-proof information about some system entity. Such as a user when authenticated

- [ ] What steps can you take in your web apps to keep your data secure?

  have protection plan in place and give the least amount of privelages away. Make users login to authenticate they have access to the application
